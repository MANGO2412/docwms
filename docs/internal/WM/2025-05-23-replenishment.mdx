...
:::info
    ...
    Si buscas replenishment con COO ve a [Replenishment con COO](./2025-05-23-replenishment.mdx### Procesar orden de replenishment con COO)
:::
...
:::info
    Recientemente fue agregado configuracion al uso de COO si buscas una configuracion con COO ve a [Configuracion](/docs/internal/WM/2025-05-23-clients.md).
